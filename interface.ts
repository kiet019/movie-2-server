...
export const listNews = [
    ...
    },
    {
      ...
      by: "SAFEEYAH KAZI",
      description:
        "The countdown is on until DC's favorite champion makes a timely return to theaters in Shazam! Fury of the Gods. Ahead of the film's release, Collider has learned that the superhero sequel's runtime is set to clock in at 2 hours and 10 minutes, just two minutes shorter than its predecessor.",
      id: "7",
    },
    {
      img: "assets/images/news8.jpg",
      title:
        "'John Wick: Chapter 4': Keanu Reeves on Epic Arc De Triomphe Stunt Sequence",
      by: "SHRISHTY",
      description:
        "The marketing for John Wick: Chapter 4 has turned up the full throttle as the March release of the movie approaches. We got the final trailer for the feature which showcases old friends and new adversaries and a very adorable dog turning up to help John. For IGN’s Fan Fest Keanu Reeves shared a new behind-the-scenes clip and promised some high-octane action sequences.",
      id: "8",
    },
    {
      img: "assets/images/news9.jpg",
      title:
        "'Avatar: The Way of Water' Wins Big at 2023 Visual Effects Society Awards",
      by: "ERICK MASSOTO",
      description:
